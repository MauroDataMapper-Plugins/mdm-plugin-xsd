...
import ox.softeng.metadatacatalogue.core.feature.FolderService
 ...
 */
class XsdImporterService extends XsdPlugin implements DataModelImporterPlugin<XsdImportParameters> {
