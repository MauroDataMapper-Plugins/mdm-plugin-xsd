...
import ox.softeng.metadatacatalogue.plugins.xsd.org.w3.xmlschema.LocalSimpleType;
...
public abstract class ElementBasedWrapper<K extends Annotated> extends AnnotatedWrapper<K> {
    ...
    DataElement createDataModelElement(CatalogueUser user, DataModel parentDataModel, SchemaWrapper schema) {
    ...
    private DataElement createDataClassElement(CatalogueUser user, DataModel parentDataModel, DataClass parentDataClass, SchemaWrapper schema,
    ...
    private DataClass findOrCreateDataClass(CatalogueUser user, DataModel parentDataModel, DataClass parentDataClass, SchemaWrapper schema,
                                            ComplexTypeWrapper complexType) {
    ...
    private DataType findOrCreateDataType(CatalogueUser user, DataModel dataModel, SchemaWrapper schema) {
        return findOrCreateDataType(user, dataModel, schema, null);
    }

    private DataType findOrCreateDataType(CatalogueUser user, DataModel dataModel, SchemaWrapper schema, DataClass referencedDataClass) {
