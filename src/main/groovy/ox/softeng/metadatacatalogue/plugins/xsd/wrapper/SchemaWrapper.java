...
import ox.softeng.metadatacatalogue.plugins.xsd.org.w3.xmlschema.FormChoice;
import ox.softeng.metadatacatalogue.plugins.xsd.org.w3.xmlschema.Include;
 ...
 * @since 24/08/2017
 */
public class SchemaWrapper extends OpenAttrsWrapper<Schema> {
    ...
    public SchemaWrapper(XsdSchemaService xsdSchemaService, String name) {
        this(xsdSchemaService, new Schema(), name);
    }

    public SchemaWrapper(XsdSchemaService xsdSchemaService, Schema schema, String name) {
    ...
    public DataModel loadIntoDataModel(DataModel dataModel, CatalogueUser createdBy, String rootElement,
    ...
    public void populateSchemaFromDataModel(DataModel dataModel, String defaultTargetNamespace) {
    ...
    DataClass createAndStoreDataClass(CatalogueUser user, DataModel parentDataModel, DataClass parentDataClass,
    ...
    DataClass findOrCreateDataClass(CatalogueUser user, DataModel parentDataModel, DataClass parentDataClass, ComplexTypeWrapper complexType) {
    ...
    private void createComplexTypes(CatalogueUser user, DataModel dataModel) {
    ...
    private void createComplexTypes(CatalogueUser user, DataModel dataModel, DataStore dataStore) {
        this.dataStore = dataStore;
        createComplexTypes(user, dataModel);
    }

    private void createElements(CatalogueUser user, DataModel dataModel, String rootElement) {
    ...
    private void createElements(CatalogueUser user, DataModel dataModel, String rootElement, DataStore dataStore) {
        this.dataStore = dataStore;
        createElements(user, dataModel, rootElement);
    }

    private void createSimpleTypes(CatalogueUser user, DataModel dataModel) {
    ...
    private Map<String, DataType> createXsdBasePrimitiveTypes(CatalogueUser user, DataModel dataModel) {
    ...
    private DataClass findOrCreateDataClass(CatalogueUser user, DataModel parentDataModel, ComplexTypeWrapper complexType) {
    ...
    public static SchemaWrapper loadSchemaFromInputStream(XsdSchemaService xsdSchemaService, InputStream is, String filename, String directory)
    ...
    private static SchemaWrapper loadSchemaFromInputStream(XsdSchemaService xsdSchemaService, InputStream inputStream, String filename,
                                                           String directory,
