 ...
 *       &lt;attribute name="xpath" use="required"$gt;
 *         &lt;simpleType$gt;
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}token"$gt;
 *             &lt;pattern value="(\.//)?(((child::)?((\i\c*:)?(\i\c*|\*)))|\.)(/(((child::)?((\i\c*:)?(\i\c*|\*)))|\.))*(\|(\.//)?(((child::)?(
 *             (\i\c*:)?(\i\c*|\*)))|\.)(/(((child::)?((\i\c*:)?(\i\c*|\*)))|\.))*)*"/$gt;
 *           &lt;/restriction$gt;
 *         &lt;/simpleType$gt;
 *       &lt;/attribute$gt;
